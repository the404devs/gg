...
*/
// Modified to add an `opacity` property to the gradient.
        ...
        _drawHotline: function(ctx) {
            ...
            for (i = 0, dataLength = this._data.length; i < dataLength; i++) {
                ...
                for (j = 1, pathLength = path.length; j < pathLength; j++) {
                    ...
                    gradient.addColorStop(0, "rgba(" + gradientStartRGB.join(",") + "," + this._opacity + ")");
                    gradient.addColorStop(1, "rgba(" + gradientEndRGB.join(",") + "," + this._opacity + ")");
    ...
    var Renderer = L.Canvas.extend({
        ...
        _updateOptions: function(layer) {
            ...
            if (layer.options.opacity != null) {
                this._hotline.opacity(layer.options.opacity);
            }
